...
//PX_n,  //Dx
  ...
  PA_11, //D31     PA11_EN, external I2C Level shifter enable
  PA_12, //D32     PA12, D12
};
...
// This board's RS485 transceiver is wired to PA_0/PA_1 backwards relative
// to the STM32L072's USART4 AF6 assignment. Declare the swap so uart_init()
// enables the chip's internal TX/RX swap feature; Serial4's pins are left
// at their normal (unswapped) default -- see the comment in
// PeripheralPins.c for why that's correct.
void initVariant(void)
{
#if defined(HAVE_HWSERIAL4)
    Serial4.setSwapTxRx(true);
#endif
}
