...
Function:
        Override USBD_LL_ConnectionState() function for MODEL_4931 variant.
...
#define USB_VBUS_PRESENT_THRESHOLD_ADC (270 * 4)        // 270 counts/1024, scaled for /4096 == 2.6 volts
#endif

// the pin that VBUS is wired to on this platform.
#ifndef USB_VBUS_DETECT_PIN
#define USB_VBUS_DETECT_PIN     14
#endif
